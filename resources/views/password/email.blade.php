  ...
  <div class="login-box-body">
    ...
    <form method="POST" action="{{ route('email') }}">
        ...
        <div class="form-group @error('email') has-error @enderror">
          ...
          <input type="text" class="form-control" id="nama" name="email" placeholder="Masukkan Email" value="{{ old('email') }}">
          @error('email')<i class="fa fa-fw fa-warning"></i>{{ $message }} @enderror
        </div>

        <div class="row">
            <div class="col-xs-5 pull-right">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Dapatkan link</button>
            </div>
        </div>
    </form>

...
@section('title', 'Tambah Kategori Lowongan')
@section('content')
<div class="box box-primary" style="width: 600px">
    <div class="box-body box-profile">
        ...
        Silakan masukkan data yang benar.
            ...
            <form role="form" method="post" action="/kategori">
              @csrf
              <div class="box-body">
                <div class="form-group @error('nama') has-error @enderror">
                  <label for="nama">Nama Kategori</label>
                  <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Kategori" value="{{ old('nama') }}">
